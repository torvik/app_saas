class StandupsController < ApplicationController
  ...
  private
    ...
    def standup_params
      params.require(:standup).permit(:standup_date, dids_attributes:[:id, :title, :_destroy],
        todos_attributes: [:id, :title, :_destroy], blockers_attributes: [:id, :title, :_destroy])
    end
    ...
    def check_for_existance
      ...
      elseif standup.nil? && action_name == 'edit'
